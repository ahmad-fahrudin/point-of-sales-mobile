  ...
  return (
    ...
    >
      ...
      <Collapsible title="File-based routing">
        <ThemedText>
          This app has two screens: <ThemedText type="defaultSemiBold">app/(drawer)/index.tsx</ThemedText> and{' '}
          <ThemedText type="defaultSemiBold">app/(drawer)/explore.tsx</ThemedText>
        </ThemedText>
        <ThemedText>
          The layout file in <ThemedText type="defaultSemiBold">app/(drawer)/_layout.tsx</ThemedText> sets up the drawer
          navigator.
        </ThemedText>
